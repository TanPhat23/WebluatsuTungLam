    ...
    <div className="flex flex-col gap-16 min-h-screen items-center text-center m-x-5">
      ...
      <div className="flex flex-row gap-20 ">
        <div className="flex flex-col text-start">
          ...
          <div className="w-1/4 h-[5px] rounded-xl bg-[#0052A2] "></div>
          <ul className="flex flex-col gap-2 mt-6">
            {aboutLinkList1.map((link) => (
              <li key={link.title}>
                <button className="w-5/6 bg-white text-black border-2 border-[#064273]">
        ...
        <div className="w-[5px] h-auto rounded-xl bg-[#0052A2] mt-16"></div>
        <div>
